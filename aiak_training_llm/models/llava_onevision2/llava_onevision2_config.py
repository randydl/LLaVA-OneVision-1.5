...
@register_model_config(model_family=VisionLanguageModelFamilies.LlavaOnevision2, model_arch="llava-onevision2-2b")
...
@register_model_config(model_family=VisionLanguageModelFamilies.LlavaOnevision2, model_arch="llava-onevision2-3b")
...
@register_model_config(model_family=VisionLanguageModelFamilies.LlavaOnevision2, model_arch="llava-onevision2-4b")
...
@register_model_config(model_family=VisionLanguageModelFamilies.LlavaOnevision2, model_arch="llava-onevision2-30b-a3b")
...
@register_model_config(model_family=VisionLanguageModelFamilies.LlavaOnevision2, model_arch="llava-onevision2-8b")
...
@register_model_config(model_family=VisionLanguageModelFamilies.LlavaOnevision2, model_arch="llava-onevision2-32b")
...
@register_model_config(model_family=VisionLanguageModelFamilies.LlavaOnevision2, model_arch="llava-onevision2-14b")
