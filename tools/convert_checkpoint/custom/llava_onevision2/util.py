...
#     # 加载checkpoint
#     load_path = "/path/to/your/checkpoint/dir"
#     state_dict = load_megatron_checkpoint_tp_ep(load_path)

#     # 保存checkpoint
#     save_path = "/path/to/save/checkpoint/dir"
#     save_megatron_checkpoint_tp_ep(state_dict, save_path)
