...
RAW_PACKING_DATA_DIR = OUTPUT_DIR.joinpath('raw_packing_data')
WEBDATASET_DIR = DEFAULT_DIRECTORY.parent.joinpath('webdataset')
...
def _add_arguments(parser: argparse.ArgumentParser):
    ...
    group.add_argument('--output_dir', type=str, default=WEBDATASET_DIR, help='Output directory')
    group.add_argument('--json_file', type=str, default=RAW_PACKING_DATA_DIR,
                       help='Directory (multi-image captioning) or single file (old format)')
    group.add_argument('--image_dir', type=str, default=RAW_PACKING_DATA_DIR, help='Image directory')
