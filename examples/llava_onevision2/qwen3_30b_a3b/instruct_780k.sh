# =============================================================================
# LLaVA-OneVision2 30B-A3B – Stage-3 Instruct Training (780K)
# =============================================================================
# Main recommended setup in this script:
#   TP=1, PP=1, EP=8
#
# Usage:
#   bash instruct_780k.sh [TP] [PP] [EP] [SEQ_LEN] [MBS] [GBS] [NSTEP]
# =============================================================================
...
NSTEP="${7:-$(((TOTAL_SAMPLES + GBS - 1) / GBS))}"
...
OUTPUT_DIR="${OUTPUT_DIR:-/ov2/xiangan/ckpts_30b_a3b_date_0318}"
DATA_PATH=${DATA_PATH:-"/ov2/dataset_sft/webdataset_llava_next_740k"}
TOKENIZER_PATH=${TOKENIZER_PATH:-"/ov2/pretrain_models/llava_onevision2/llava_onevision2_30b_a3b/auto_model"}
...
TRAINING_ARGS=(
    ...
    --custom-pipeline-recompute-layers 1,1 # ViT 24layers
    --custom-pipeline-layers 16,32
)
