# =============================================================================
# LLaVA-OneVision2 4B-p14m2 – Convert HuggingFace checkpoint to Megatron-Core
# =============================================================================
#
# Usage:
#   bash convert_4b_p14m2_hf_to_mcore.sh <LOAD> <SAVE> <TP> <PP> [CUSTOM_PIPELINE_LAYERS]
#
# Arguments:
...
#
# Examples:
#   bash convert_4b_p14m2_hf_to_mcore.sh /src /dst 2 4 0,12,12,12
#   bash convert_4b_p14m2_hf_to_mcore.sh /src /dst 1 1
# =============================================================================
