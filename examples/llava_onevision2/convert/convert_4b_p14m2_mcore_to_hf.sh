# =============================================================================
# LLaVA-OneVision2 4B-p14m2 – Convert Megatron-Core checkpoint to HuggingFace
# =============================================================================
#
# Usage:
#   bash convert_4b_p14m2_mcore_to_hf.sh <LOAD> <SAVE> <TP> <PP> [CUSTOM_PIPELINE_LAYERS]
#
# Arguments:
...
#
# Examples:
#   bash convert_4b_p14m2_mcore_to_hf.sh /src /dst 2 4 0,12,12,12
#   bash convert_4b_p14m2_mcore_to_hf.sh /src /dst 1 1
# =============================================================================
...
python $CONVERT_CHECKPOINT_PATH/model.py \
    ...
    --common_config_path=$CONVERT_CHECKPOINT_PATH/config/llava-onevision2-4b-p14m2/qwen3.json \
...
python $CONVERT_CHECKPOINT_PATH/model.py \
    ...
    --save_platform=huggingface \
    --megatron_path $AIAK_MAGATRON_PATH \
    --common_config_path=$CONVERT_CHECKPOINT_PATH/config/llava-onevision2-4b-p14m2/vision-model.json \
    --tensor_model_parallel_size=$TP \
...
python $CONVERT_CHECKPOINT_PATH/custom/llava_onevision2/adapter.py \
    ...
    --save_platform=huggingface \
    --megatron_path $AIAK_MAGATRON_PATH \
    --common_config_path=$CONVERT_CHECKPOINT_PATH/config/llava-onevision2-4b-p14m2/adapter.json \
    --tensor_model_parallel_size=$TP \
    --pipeline_model_parallel_size=$PP \
    --load_ckpt_path=$LOAD \
...
python $CONVERT_CHECKPOINT_PATH/custom/llava_onevision2/vision_patch.py \
    ...
    --tensor_model_parallel_size=$TP \
    --pipeline_model_parallel_size=$PP \
    --common_config_path=$CONVERT_CHECKPOINT_PATH/config/llava-onevision2-4b-p14m2/vision-patch.json \
    --load_ckpt_path=$LOAD \
